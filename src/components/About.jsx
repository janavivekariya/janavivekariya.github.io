  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center w-full h-full py-8 md:py-12">
        <div className="bg-cyan-800 rounded-md max-w-[1200px] flex flex-col md:flex-row p-4 md:p-7 py-10 ">
          <div className="md:w-1/2 md:pr-4 md:p-14">
            <p className="text-2xl sm:text-3xl md:text-4xl text-center md:text-left font-bold border-b-4 border-cyan-500">
              More About Me <br />
            </p>
            ...
            <Link
              ...
              duration={500}
              offset={-80}
              className="group text-cyan-800 px-6 py-3 flex items-center rounded-md bg-white cursor-pointer mt-4 md:mt-8"
          ...
          <div className="md:w-1/2 mx-auto mt-4 md:mt-20">
            <img
              src={me}  
              alt="my profile"
